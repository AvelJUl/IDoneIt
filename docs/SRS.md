...
Большинство аналогов данного приложения являются сложно организованным программным обеспечением. Основной отличительной особенность данного приложения являются ограниченный набор предоставляемых функциональных возможностей и возможность организовывать встречи.</br>
...
1. <b> Jira https://www.atlassian.com/software/jira </b><br>
	...
	- отсутсвие возможности назначения нескольких исполненителей для одной задачи.
