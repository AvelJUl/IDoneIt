...
5. Приложение удаляет информацию о выбранных учётных записях из базы даннах.
6. Приложение отображает страницу просмотра списка учётных записей с учётом изменений в базе данных.
7. Вариант использования завершён.
