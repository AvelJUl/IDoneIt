...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.2.4.3. [(DELETE) Удалить роль](#1.2.4.3)<br>
...
<b>Предусловия: </b> Пользователь, авторизовавший в системе как администратор, находится на странице просмотра списка ролей.
...
7. Приложение создаёт роль и сохранеят её в базе данных.
...
<b>Предусловия: </b> Пользователь, авторизовавший в системе, находится на странице просмотра ролей.
...
#### 1.2.4.3\. (DELETE) Удалить роль <a name = "1.2.4.3"></a>
...
2. Приложение удаляет информацию о выбранных ролях из базы даннах.
